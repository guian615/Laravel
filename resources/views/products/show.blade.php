...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col-sm">
            <img src="https://image.freepik.com/free-vector/team-is-developing-application-vector-illustration_82574-3177.jpg"
                        ...
                        <div class="more-info">
                            ...
                            <div class="row">
                                ...
                                <div class="pull-right mt-4">
                                    ...
                                    <a class="btn btn-success" href="{{ route('products.index') }}"> <i
